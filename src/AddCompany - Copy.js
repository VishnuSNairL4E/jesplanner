	...
	return (
		<React.Fragment>
				...
				<Form>
					<Form.Group>
						<Grid style={{ width: '100%' }}>
							<Grid.Row>
								<Grid.Column width={8}>
									<Form.Input onChange={handleChange('companyName')} value={companyName} style={{ marginRight: '20px' }} fluid label='	Company name *' placeholder='Company name' />
								</Grid.Column>
								<Grid.Column width={4}>
									<Form.Input onChange={handleChange('shortName')} value={shortName} style={{ marginRight: '20px' }} fluid label='Company Short Name *' placeholder='Company Short Name' />
								</Grid.Column>
								<Grid.Column width={4}>
									<Form.Input onChange={handleChange('companyCode')} value={companyCode} fluid label='Company code *' placeholder='Company code' />
								</Grid.Column>
							</Grid.Row>
							<Grid.Row>
								<Grid.Column width={4}>
									<Label style={{ marginLeft: "-10px" }}> Status </Label><br />
			...
			<div id="Component_1270__1" class="Component_1270___1">
				<Grid style={{ width: '100%' }}>
					<Grid.Row style={{padding: "15px"}}>
						<div id="Rectangle_3365">
							<Form style={{ padding: "25px" }}>
								<Form.Group>

									<Grid style={{ width: '100%' }}>
										<Grid.Row className="addnew_res">
											<Grid.Column width={8}>
												<Form.Input onChange={handleChangeResource('resourceName')} value={resourceName} style={{ marginRight: '20px' }} fluid label='	Employee name *' placeholder='Employee name' />
											</Grid.Column>
											<Grid.Column width={8}>
												<Form.Input onChange={handleChangeResource('resourceCode')} value={resourceCode} fluid label='Employee Code *' placeholder='Employee Code' />
											</Grid.Column>
											<Grid.Column width={8}>
												<Form.Input onChange={handleChangeResource('designation')} value={designation} style={{ marginRight: '20px' }} fluid label='	Designation *' placeholder='Designation' />
											</Grid.Column>
											<Grid.Column width={8}>
												<Form.Field onChange={handleChangeRole} value={role} control={Select} label='Role *' style={{ marginRight: '20px' }} options={options} placeholder='Select' />
											</Grid.Column>
											<Grid.Column width={8}>
												<Form.Input onChange={handleChangeResource('phone')} value={phone} style={{ marginRight: '20px' }} fluid label='Phone No*' placeholder='Phone No' />
											</Grid.Column>
											<Grid.Column width={8}>
												<Form.Input onChange={handleChangeResource('email')} value={email} fluid label='Email *' placeholder='Email' />
											</Grid.Column>
											<Grid.Column width={8}>
												<Form.Input onChange={handleChangeResource('passcode')} value={passcode} style={{ marginRight: '20px' }} fluid label='Passcode*' placeholder='Passcode' />
											</Grid.Column>
											<Grid.Column width={8}>
												<Label style={{ paddingLeft: 0 }}> Status</Label>
												<Checkbox onClick={handleStatusResource} toggle defaultChecked style={{ paddingTop: "30px", paddingLeft: "10px" }} />
											</Grid.Column>
											<Grid.Column className="addnew_pp" width={8}>
												<Label style={{ paddingLeft: 0 }}> Profile Picture *</Label>
												<Form.Field>
													<Button className="dropzone" as="label" htmlFor="file" type="button">
														Drag & Drop or Click to Upload
