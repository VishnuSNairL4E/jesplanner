						...
						<Form>
							<Form.Group>
								<Grid style={{ width: '100%' }}>
									<Grid.Row>
										<Grid.Column width={8}>
											<Form.Input onChange={handleChange('customerName')} value={customerName} style={{ marginRight: '20px' }} fluid label='	Customer name *' placeholder='Customer name' />
										</Grid.Column>
										<Grid.Column width={4}>
											<Form.Input onChange={handleChange('shortName')} value={shortName} style={{ marginRight: '20px' }} fluid label='Customer Short Name *' placeholder='Customer Short Name' />
										</Grid.Column>
										<Grid.Column width={4}>
											<Form.Input onChange={handleChange('customerCode')} value={customerCode} fluid label='Customer code *' placeholder='Customer code' />
										</Grid.Column>
									</Grid.Row>
								</Grid>
							</Form.Group>
